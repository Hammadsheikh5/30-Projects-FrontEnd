              ...
              <CardContent>
                ...
                >
                  ...
                  <Draggable
                    ...
                    onStop={(_, data) => setTextPosition({ x: data.x, y: data.y })}
                  >
                    <div
                ...
                <Button className="w-full mt-4" onClick={handleDownload} disabled={downloading}>
                  {downloading ? <ClipLoader className="w-6 h-6 text-white" /> : "Download Meme"}
                </Button>
              </CardContent>
            </Card>
          )}
